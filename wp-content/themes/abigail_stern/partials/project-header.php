...
<div id="work-slides">
    ...
    <div id="work-prev" data-id="<?php echo $prev->ID; ?>" data-link="<?php echo get_permalink($prev->ID); ?>">
        ...
        <div class="project-details">
            <h3><?php the_field('project_name', $prev->ID) ?></h3>
            <p><?php the_field('project_description', $prev->ID) ?></p>
        </div>
        <ul class="project-thumbnails">

            <?php if(get_field('image_1', $prev->ID)) { ?>
            ...
            <?php if(get_field('image_2')) { ?>
                ...
                <li class="project-thumbnail-2">
                    ...
                    $imageArray = get_field('image_2', $prev->ID);
                    $imageAlt = $imageArray['alt'];
                    $imageThumbURL = $imageArray['url'];
            ...
            <?php if(get_field('image_3')) { ?>
                ...
                <li class="project-thumbnail-3">
                    ...
                    $imageArray = get_field('image_3', $prev->ID);
                    $imageAlt = $imageArray['alt'];
                    $imageThumbURL = $imageArray['url'];
             ...
             <?php if(get_field('image_4', $prev->ID)) { ?>
    ...
    <div id="work-next" data-id="<?php echo $next->ID; ?>" data-link="<?php echo get_permalink($next->ID); ?>">
        ...
        <div class="project-details">
            <h3><?php the_field('project_name', $next->ID) ?></h3>
            <p><?php the_field('project_description', $next->ID) ?></p>
        </div>
        <ul class="project-thumbnails">

            <?php if(get_field('image_1', $next->ID)) { ?>
            ...
            <?php if(get_field('image_2', $next->ID)) { ?>
            ...
            <?php if(get_field('image_3', $next->ID)) { ?>
             ...
             <?php if(get_field('image_4', $next->ID)) { ?>
